...
export const metadata: Metadata = {
  title: {
    default: 'The Art of the Prompt - Master AI Communication Like a Pro',
    template: '%s | The Art of the Prompt',
  },
  ...
  authors: [{ name: 'Eric Keller' }],
  creator: 'Eric Keller',
  publisher: 'Eric Keller',
  formatDetection: {
    email: false,
    address: false,
    telephone: false,
  },
  metadataBase: new URL(process.env.NEXT_PUBLIC_SITE_URL || 'https://PromptLabBook.com'),
  alternates: {
    canonical: '/',
  },
  openGraph: {
